...
//   return (
//     <div className="min-h-screen bg-[#eef1f4] p-4 md:p-6 lg:p-8">
//       <div className="max-w-7xl mx-auto bg-[white] rounded shadow-md border border-gray-200 p-6">
...
//                 className={`px-8 py-2.5 font-normal bg-[#0aa699] text-base transition-colors ${
//                   viewMode === 'month'
...
//           <div className="bg-[white] rounded-[5px] ml-[30px] mr-[30px] mt-[20px] shadow-sm overflow-hidden border border-[gray]">
//             <div className="grid grid-cols-7">
//               {daysOfWeek.map((day) => (
//                 <div
//                   key={day}
//                   className="text-center py-4 text-[20px] font-semibold text-[#8C8C8C] bg-gray-200 border-r border-b border-[#8C8C8C] last:border-r-0"
//                 >
//                   {day}
//                 </div>
//               ))}
...
//                   <div
//                     key={index}
//                     className={`min-h-[150px] border-b border-[#8C8C8C] p-4 ${
...
// {viewMode === 'week' && (
//   <div className="bg-white rounded-[5px] w-full max-w-full lg:w-[1300px] ml-0 lg:ml-[40px] mt-[20px] shadow-sm overflow-x-auto border border-gray-300">
//     <div className="min-w-[900px]">
//       {/* Week Header */}
//       <div className="grid grid-cols-8 bg-gray-200 border-b border-[#8C8C8C]">
//         <div className="text-left py-3 px-3 text-sm font-normal text-gray-600 border-r border-[#8C8C8C]">
//           all-day
//         </div>
//         {weekDays.map((day, index) => (
//           <div
//             key={index}
//             className="text-center py-3 text-sm font-semibold text-[#8C8C8C] border-r border-[#8C8C8C] last:border-r-0"
//           >
...
//           <div key={timeIndex} className="grid grid-cols-8 border-b border-gray-300">
//             <div className="bg-gray-100 text-left py-4 px-3 text-sm text-gray-600 border-r border-gray-300">
//               {time}
//             </div>
//             {weekDays.map((day, dayIndex) => (
//               <div
//                 key={dayIndex}
//                 className="min-h-[60px] p-2 border-r border-gray-300 last:border-r-0 bg-white hover:bg-gray-50 transition-colors"
//               >
    ...
    <div className="min-h-screen bg-[#eef1f4] p-4 md:p-6 lg:p-8">
      <div className="max-w-7xl mx-auto bg-[white] rounded shadow-md border border-gray-200 p-6">
        <div className="bg-[#ffffff] rounded p-4">
          ...
          {viewMode === 'month' && (
            <div className="bg-[white] text-[20px] rounded-[5px] ml-[30px] mr-[30px] mt-[20px] shadow-sm overflow-hidden border border-[gray]">
          ...
          {viewMode === 'week' && (
            <div className="bg-white rounded-[5px] mx-4 sm:mx-6 lg:mx-[30px] mt-[20px] shadow-sm overflow-hidden border border-gray-300">
              {/* Responsive Container with Horizontal Scroll */}
              <div className="overflow-y-auto">
                <div className="min-w-[400px] lg:min-w-[900px]">
                  {/* Week Header */}
                  <div className="grid grid-cols-8 bg-[#e5e9ec] border-b border-[#8C8C8C] sticky top-0 z-10">
                    <div className="text-left py-2 sm:py-3 px-2 text-xs sm:text-sm font-normal text-gray-600 border-r border-[#8C8C8C]">
                      All-day
                    </div>
                    {weekDays.map((day, dayIndex) => (
                      <div
                        key={dayIndex}
                        className="text-center min-h-[50px] sm:min-h-[60px] p-1 sm:p-2 border-r border-gray-300 last:border-r-0 bg-white hover:bg-gray-50 transition-colors flex flex-col items-center justify-center"
                      >
                  ...
                  <div className="overflow-y-auto max-h-[400px] sm:max-h-[500px] lg:max-h-[600px]">
                    {timeSlots.map((time, timeIndex) => (
                      <div key={timeIndex} className="grid grid-cols-8 border-b border-gray-200 hover:bg-gray-50">
                        <div className="bg-[#e5e9ec] text-left py-3 sm:py-4 px-2 sm:px-3 text-xs sm:text-sm text-gray-600 border-r border-gray-300 font-medium">
                          {time}
                        </div>
                        {weekDays.map((day, dayIndex) => (
                          <div
